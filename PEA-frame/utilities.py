...
def getMFE_ifdyn(verbose,VE,VI,DEE,DEI,DIE,DII,DEY,DIY,pop_idx_E,pop_idx_I):
    ...
    # >>> NPATCH obtained from VE should equal to that from VI >>>
    if NPATCH!=NPATCH1:
    ...
    # >>> Squeezing could get 1-D I_fired and E_fired >>>
    ...
    # >>> Must use .copy(), or the location rather than the value will be re-use, and VE&VI will change >>>
